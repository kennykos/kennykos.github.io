...
We will prove the [Time Limited Energy Maximization Principle for Bandlimited Functions](#energy-maximization-property). The energy maximization principle was originally introduced in a sequence of papers from {% cite Slepian_Pollak_1961 %} and {% cite Landau_Pollak_1961 %} as a direct corollary to a novel proof of Heisenberg's *uncertainty principle*. This report can be though of as a concise recounting of these papers with the singular focus of proving the energy maximization principle; that is, we will follow the proofs introduced in the papers of Slepain, Pollack and Landau to a T while streamlining the structure to best emphasize our particular result. 
